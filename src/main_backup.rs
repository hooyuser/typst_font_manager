...
//     deserialize_fonts_from_file, deserialize_fonts_from_toml, TypstFont,
// };
//
...
//
//     let font_config =
//         deserialize_fonts_from_file(&config_file).expect("Failed to parse font config file");
//
...
//         println!(
//             r#"Cannot find the font directory {:?} specified in {:?}"#,
//             font_dir, config_file
//         );
//         if action == "Checking" {
...
//             std::fs::create_dir_all(&absolute_font_dir).expect("Failed to create font directory");
//         }
//     } else {
...
//         .expect("Failed to parse embedded fonts")
//         .fonts
//         .iter()
//         .cloned()
//         .collect();
...
//         "\n- {} (total {}){}",
//         "Current fonts".bold(),
//         current_font_set.len(),
//         if current_font_set.is_empty() { "" } else { ":" }
//     );
...
//         let bullet = if embedded_fonts.contains(font) {
//             "●".bright_green()
//         } else if !missing_fonts.contains(font) {
//             "●".green()
...
//         "Missing fonts".bold(),
//         missing_fonts.len(),
//         if missing_fonts.is_empty() { "" } else { ":" }
//     );
...
//     println!(
//         "\n- {} (total {}){}",
//         "Redundant fonts".bold(),
//         redundant_fonts.len(),
//         if redundant_fonts.is_empty() { "" } else { ":" }
//     );
...
//                         font_dir.join(&source_path.file_name().unwrap())
//                     );
//                     std::fs::copy(&source_path, &dest_path).expect("Failed to copy font file");
//                 } else {
